...
public class TxEmisorClientTest {
    /* String Request. */
    ...
    /* Clase Test. */
    @InjectMocks
    private static TxEmisorClient base;
    @InjectMocks
    private static TxEmisorClient equal;
    @InjectMocks
    private static TxEmisorClient notEqual;
    @InjectMocks
    private static TxEmisorClient nulo;
    @InjectMocks
    private static TxEmisorClient object3;
    ...
    public void initMocks() {
        base = new TxEmisorClient();
        equal = new TxEmisorClient();
        notEqual = new TxEmisorClient();
        nulo = null;
        object3 = new TxEmisorClient();
    ...
    public void testDifferent() {
        ...
        assertNotEquals(base.hashCode(), null);
    ...
    @Test
    public void txEmiteNegocioTest() {
        base.txEmiteNegocio(objReq, "http://wsp-txlogger-qa.oscp.gnp.com.mx/txlogger");
        assertNotNull(base);
    }
    
    @Test(expected = NullPointerException.class)
    public void validaAgentesEmptyTest() {
        assertTrue(true);
        base.validaAgentes(objReq.getAgentes());
    }
    
    @Test
    public void validaAgentesTest() {
        base.validaAgentes(ObjetosPruebas.getAgentes());
        assertNotNull(base);
    }
}
